...
|---|---|---|---:|---:|---:|---:|
| ReplicaCAD 家具 · 通道開放 | RGB-D · 全部觀測 | 可通行 | 24 | 93.3% | — | 2.32 |
| ReplicaCAD 家具 · 通道開放 | RGB-D · 固定間隔 | 未知 | 8 | 81.0% | — | 0.86 |
| ReplicaCAD 家具 · 通道開放 | RGB-D · 覆蓋選樣 | 可通行 | 8 | 92.8% | — | 1.06 |
| ReplicaCAD 家具 · 通道開放 | DA3 Metric · 全部觀測 | 阻斷 | 24 | 92.5% | 0.299 m | 23.19 |
| ReplicaCAD 家具 · 通道開放 | DA3 Metric · 固定間隔 | 阻斷 | 8 | 72.5% | 0.279 m | 7.62 |
| ReplicaCAD 家具 · 沙發移至通道 | RGB-D · 全部觀測 | 阻斷 | 24 | 88.9% | — | 2.41 |
| ReplicaCAD 家具 · 沙發移至通道 | RGB-D · 固定間隔 | 阻斷 | 8 | 62.6% | — | 0.76 |
| ReplicaCAD 家具 · 沙發移至通道 | RGB-D · 覆蓋選樣 | 阻斷 | 8 | 88.4% | — | 0.91 |
| ReplicaCAD 家具 · 沙發移至通道 | DA3 Metric · 全部觀測 | 阻斷 | 24 | 83.0% | 0.405 m | 23.11 |
| ReplicaCAD 家具 · 沙發移至通道 | DA3 Metric · 固定間隔 | 阻斷 | 8 | 60.7% | 0.373 m | 7.68 |
| ReplicaCAD 家具 · 觀測不足 | RGB-D · 全部觀測 | 未知 | 1 | 40.2% | — | 0.13 |
| ReplicaCAD 家具 · 觀測不足 | RGB-D · 固定間隔 | 未知 | 1 | 40.2% | — | 0.13 |
| ReplicaCAD 家具 · 觀測不足 | RGB-D · 覆蓋選樣 | 未知 | 1 | 40.2% | — | 0.12 |
| ReplicaCAD 家具 · 觀測不足 | DA3 Metric · 全部觀測 | 未知 | 1 | 43.4% | 0.460 m | 1.01 |
| ReplicaCAD 家具 · 觀測不足 | DA3 Metric · 固定間隔 | 未知 | 1 | 43.4% | 0.460 m | 1.01 |

每種方法只有 3 個固定查詢，樣本很小；MAE 以所選有效像素加權。RGB-D 使用無噪聲合成深度，故不是感測器實測誤差。
方法秒數為原始各影格推論時間加本次融合時間；快取重用不重新消耗相同推論時間。完整軌跡不代表完整觀測幾何。

| 方法 | N | 可通／阻斷／未知 | 決策覆蓋率 | 錯放／oracle 阻斷 | 錯放／預測可通 |
|---|---:|---|---:|---|---|
| all | 3 | 1/1/1 | 66.7% | 0/1 | 0/1 |
| interval | 3 | 0/1/2 | 33.3% | 0/1 | N/A（沒有放行） |
| coverage | 3 | 1/1/1 | 66.7% | 0/1 | 0/1 |
| da3-all | 3 | 0/2/1 | 66.7% | 0/1 | N/A（沒有放行） |
| da3-interval | 3 | 0/2/1 | 66.7% | 0/1 | N/A（沒有放行） |

錯誤放行：預測可通行、oracle 判阻斷。兩個分母分別為 oracle 阻斷查詢數，以及預測可通行查詢數；零分母為 N/A。
...
```json
{
  "wall_seconds": 51.42903949999891,
  "cache_hits": 5,
  "cache_misses": 44,
  "failures": [],
  "peak_vram_mb": null,
